...
from .login import LoginForm, SignUpForm, KeyForm, AwsInstance, UnknownForm
...
def login(request):
   ...
   if request.session.has_key('username'):
      ...
      return render(request, 'config.html', {'username':username})
   ...
   if request.method == 'POST':
      ...
      if sform.is_valid():
         ...
         if Employee.objects.filter(email = sform.cleaned_data['email']).count()>0:
            ...
            sform = LoginForm()
            return render(request,'index.html',{'sform':sform, 'message':message})
            ...
            try:
               ...
               if kform.is_valid():
                  ...
                  try:
                     ...
                     return render(request, 'dashboard.html',{'username':username, 'instance':instance})
                  except:
                     pass
